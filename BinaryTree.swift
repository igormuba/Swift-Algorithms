...
class Tree{
    ...
    func addNode(value: Int){
        if head == nil{
            ...
            searchAndAdd(value: value, node: head!)
        }
    }
    
    private func searchAndAdd(value: Int, node: Node){
        if node.value != value{
            ...
            if value > node.value{
                if node.right == nil{
                    ...
                    searchAndAdd(value: value, node: node.right!)
                }
            }
                ...
                if node.left == nil{
                    ...
                    searchAndAdd(value: value, node: node.left!)
                }
            }
        }
    }
...
let headNode=tree.head;

print(headNode!.asString);
